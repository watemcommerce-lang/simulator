    ...
    >
      <div className="w-full max-w-sm">
        ...
        >
          ...
          {/* Botão principal — fora do form, bem destacado */}
          <button
            onClick={handleSubmit}
            disabled={isPending}
            className="w-full py-3.5 rounded-xl text-white font-bold text-base flex items-center justify-center gap-2 transition-opacity"
            style={{
